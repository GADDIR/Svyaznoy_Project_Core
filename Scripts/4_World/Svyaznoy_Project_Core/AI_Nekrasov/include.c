// INCLUDE.C — ГЛОБАЛЬНАЯ СИНХРОНИЗАЦИЯ МОДУЛЕЙ РАЗУМА "СВЯЗНОГО"
// Порядок загрузки определен иерархией наследования блоков

// 1. Фундамент и Генезис
#include "Scripts/4_World/Svyaznoy_Project_Core/AI_Nekrasov/Nekrasov_Genesis_Registry.c"

// 2. Хранилища и Аналитика
#include "Scripts/4_World/Svyaznoy_Project_Core/AI_Nekrasov/Nekrasov_Memory_Buffer.c"
#include "Scripts/4_World/Svyaznoy_Project_Core/AI_Nekrasov/Nekrasov_Skill_Memory.c"
#include "Scripts/4_World/Svyaznoy_Project_Core/AI_Nekrasov/Nekrasov_Trust_System.c"

// 3. Моральные и этические фильтры
...
#include "Scripts/4_World/Svyaznoy_Project_Core/AI_Nekrasov/Nekrasov_Radio_Tower_Sync.c"

// 5. Точка сборки и Ядро
#include "Scripts/4_World/Svyaznoy_Project_Core/AI_Nekrasov/Nekrasov_Identity.c"
#include "Scripts/4_World/Svyaznoy_Project_Core/AI_Nekrasov/AI_PersonalityCore.c"
